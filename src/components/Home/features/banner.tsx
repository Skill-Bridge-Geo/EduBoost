...
const Banner: React.FC = () => {
  ...
  const handleArrowClick = (direction: "back" | "forward"): void => {
    if (direction === "back") {
      setBannerPage(bannerPage === 1 ? bannerPagesNumber : bannerPage - 1);
    } else {
      setBannerPage(bannerPage === bannerPagesNumber ? 1 : bannerPage + 1);
    }
  };
  ...
  return (
    <div className="parent-banner">
      <div className="banner">
        ...
        <div className="arrow-back" onClick={() => handleArrowClick("back")}>
